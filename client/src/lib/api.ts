 ...
 * event. AuthProvider listens, clears its cached user, and AdminGate
 * bounces to /login. Centralizing it here means callers never have to
 * special-case session expiry.
 */
