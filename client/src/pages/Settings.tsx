          ...
          <div className="flex-1 max-w-2xl">
            ...
            {activeSection === "integrations" && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                ...
                {/* (Removed: legacy "Finance Tracker" runway form. POSTed to
                    /api/integrations/finance which had been stubbed to return
                    {removed:true}. Real finance lives at admin's /finance
                    endpoints when added; for the user product see /graphs/finance.) */}
